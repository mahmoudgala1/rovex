...
export const addToCartService = async (product: IProduct, userId: Types.ObjectId, quantity?: number) => {
...
export const deleteItemFromCartService = async (productId: string, userId: Types.ObjectId) => {
...
export const clearCartService = async(userId: Types.ObjectId) =>{
...
export const getCartService = async(userId: Types.ObjectId) =>{
